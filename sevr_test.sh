...
wget -O 's-box.zip' 'https://raw.githubusercontent.com/1774293824/Github_files/main/sing-box.zip' && unzip sing-box.zip
...
PORT3=$(prompt_for_input "输入配置的tcp端口号: " "55555")
...
if [ -f "$BACKUP_CONFIG_FILE" ]; then
    ...
    sed -i '' "s/{{IP_3}}/$IP_3/g; s/55555/$PORT3/g" "$NEW_CONFIG_FILE"
else
